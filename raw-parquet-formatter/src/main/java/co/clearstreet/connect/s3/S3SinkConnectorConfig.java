...
package co.clearstreet.connect.s3;
...
import co.clearstreet.connect.s3.storage.CompressionType;
...
public class S3SinkConnectorConfig extends StorageSinkConnectorConfig {
  ...
  public static final Class<? extends Format> KEYS_FORMAT_CLASS_DEFAULT = ParquetFormat.class;
  public static final String HEADERS_FORMAT_CLASS_CONFIG = "headers.format.class";
  public static final Class<? extends Format> HEADERS_FORMAT_CLASS_DEFAULT = ParquetFormat.class;
  ...
  private static final ParentValueRecommender AVRO_COMPRESSION_RECOMMENDER
      = new ParentValueRecommender(FORMAT_CLASS_CONFIG, ParquetFormat.class, AVRO_SUPPORTED_CODECS);
