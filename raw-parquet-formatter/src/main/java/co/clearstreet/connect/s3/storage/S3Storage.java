...
package co.clearstreet.connect.s3.storage;
...
import co.clearstreet.connect.s3.format.parquet.ParquetFormat;
import co.clearstreet.connect.s3.util.S3ProxyConfig;
import co.clearstreet.connect.s3.util.Version;
import io.confluent.connect.storage.Storage;
import io.confluent.connect.storage.common.util.StringUtils;

import static co.clearstreet.connect.s3.S3SinkConnectorConfig.AWS_ACCESS_KEY_ID_CONFIG;
import static co.clearstreet.connect.s3.S3SinkConnectorConfig.AWS_SECRET_ACCESS_KEY_CONFIG;
import static co.clearstreet.connect.s3.S3SinkConnectorConfig.REGION_CONFIG;
import static co.clearstreet.connect.s3.S3SinkConnectorConfig.S3_PATH_STYLE_ACCESS_ENABLED_CONFIG;
import static co.clearstreet.connect.s3.S3SinkConnectorConfig.S3_PROXY_URL_CONFIG;
import static co.clearstreet.connect.s3.S3SinkConnectorConfig.S3_RETRY_BACKOFF_CONFIG;
import static co.clearstreet.connect.s3.S3SinkConnectorConfig.S3_RETRY_MAX_BACKOFF_TIME_MS;
import static co.clearstreet.connect.s3.S3SinkConnectorConfig.WAN_MODE_CONFIG;
